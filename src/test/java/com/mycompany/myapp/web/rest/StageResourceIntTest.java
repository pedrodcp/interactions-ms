...
import com.mycompany.myapp.InteractionsApp;
...
@SpringBootTest(classes = InteractionsApp.class)
public class StageResourceIntTest {
    ...
    public void setup() {
        ...
        final StageResource stageResource = new StageResource(stageRepository, stageSearchRepository);
