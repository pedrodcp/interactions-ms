...
public class InteractionsApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(InteractionsApp.class);

    private final Environment env;

    public InteractionsApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(InteractionsApp.class);
